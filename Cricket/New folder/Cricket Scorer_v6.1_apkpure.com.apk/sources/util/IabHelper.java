...
public class IabHelper {
    ...
    public void disposeWhenFinished() {
        ...
        L_0x0015:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: util.IabHelper.disposeWhenFinished():void");
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:22:0x009b A[Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }] */
    /* JADX WARNING: Removed duplicated region for block: B:25:0x00c3 A[Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void launchPurchaseFlow(android.app.Activity r15, java.lang.String r16, java.lang.String r17, java.util.List<java.lang.String> r18, int r19, util.IabHelper.OnIabPurchaseFinishedListener r20, java.lang.String r21) throws util.IabHelper.IabAsyncInProgressException {
        /*
            r14 = this;
            r1 = r14
            r9 = r16
            ...
            if (r2 != 0) goto L_0x0035
            util.IabResult r2 = new util.IabResult
            r3 = -1009(0xfffffffffffffc0f, float:NaN)
            java.lang.String r4 = "Subscriptions are not available."
            r2.<init>(r3, r4)
            r1.flagEndAsync()
            if (r12 == 0) goto L_0x0034
            r12.onIabPurchaseFinished(r2, r13)
        L_0x0034:
            return
        L_0x0035:
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r2.<init>()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r3 = "Constructing buy intent for "
            r2.append(r3)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r2.append(r9)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r3 = ", item type: "
            r2.append(r3)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r2.append(r10)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r2 = r2.toString()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r1.logDebug(r2)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            if (r18 == 0) goto L_0x0084
            boolean r2 = r18.isEmpty()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            if (r2 == 0) goto L_0x005a
            goto L_0x0084
        L_0x005a:
            boolean r2 = r1.mSubscriptionUpdateSupported     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            if (r2 != 0) goto L_0x0070
            util.IabResult r2 = new util.IabResult     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r3 = -1011(0xfffffffffffffc0d, float:NaN)
            java.lang.String r4 = "Subscription updates are not available."
            r2.<init>(r3, r4)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r1.flagEndAsync()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            if (r12 == 0) goto L_0x006f
            r12.onIabPurchaseFinished(r2, r13)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
        L_0x006f:
            return
        L_0x0070:
            com.android.vending.billing.IInAppBillingService r2 = r1.mService     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r3 = 5
            android.content.Context r4 = r1.mContext     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r4 = r4.getPackageName()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r5 = r18
            r6 = r9
            r7 = r10
            r8 = r21
            android.os.Bundle r2 = r2.getBuyIntentToReplaceSkus(r3, r4, r5, r6, r7, r8)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            goto L_0x0095
        L_0x0084:
            com.android.vending.billing.IInAppBillingService r2 = r1.mService     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r3 = 3
            ...
            r6 = r10
            r7 = r21
            android.os.Bundle r2 = r2.getBuyIntent(r3, r4, r5, r6, r7)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
        L_0x0095:
            int r3 = r1.getResponseCodeFromBundle(r2)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            if (r3 == 0) goto L_0x00c3
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r2.<init>()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r4 = "Unable to buy item, Error response: "
            r2.append(r4)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r4 = getResponseDesc(r3)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r2.append(r4)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r2 = r2.toString()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r1.logError(r2)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r1.flagEndAsync()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            util.IabResult r2 = new util.IabResult     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r4 = "Unable to buy item"
            r2.<init>(r3, r4)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
        ...
        L_0x00c3:
            ...
            android.os.Parcelable r2 = r2.getParcelable(r3)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            android.app.PendingIntent r2 = (android.app.PendingIntent) r2     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r3.<init>()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r4 = "Launching buy intent for "
            r3.append(r4)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r3.append(r9)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r4 = ". Request code: "
            r3.append(r4)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r3.append(r11)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.String r3 = r3.toString()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r1.logDebug(r3)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r1.mRequestCode = r11     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r1.mPurchaseListener = r12     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r1.mPurchasingItemType = r10     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            android.content.IntentSender r3 = r2.getIntentSender()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            android.content.Intent r5 = new android.content.Intent     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r5.<init>()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r2 = 0
            java.lang.Integer r4 = java.lang.Integer.valueOf(r2)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            int r6 = r4.intValue()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.Integer r4 = java.lang.Integer.valueOf(r2)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            int r7 = r4.intValue()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            int r8 = r2.intValue()     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            r2 = r15
            r4 = r11
            r2.startIntentSenderForResult(r3, r4, r5, r6, r7, r8)     // Catch:{ SendIntentException -> 0x0140, RemoteException -> 0x0115 }
            goto L_0x016a
        L_0x0115:
            r0 = move-exception
            r2 = r0
            ...
            r3.<init>()
            java.lang.String r4 = "RemoteException while launching purchase flow for sku "
            r3.append(r4)
            r3.append(r9)
        ...
        L_0x0140:
            ...
            java.lang.StringBuilder r3 = new java.lang.StringBuilder
            r3.<init>()
            java.lang.String r4 = "SendIntentException while launching purchase flow for sku "
            r3.append(r4)
            r3.append(r9)
            java.lang.String r3 = r3.toString()
            r1.logError(r3)
        ...
        L_0x016a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: util.IabHelper.launchPurchaseFlow(android.app.Activity, java.lang.String, java.lang.String, java.util.List, int, util.IabHelper$OnIabPurchaseFinishedListener, java.lang.String):void");
    }
    ...
    public boolean handleActivityResult(int i, int i2, Intent intent) {
        ...
        if (i2 == -1 && responseCodeFromIntent == 0) {
            ...
            if (this.mPurchaseListener != null) {
                this.mPurchaseListener.onIabPurchaseFinished(iabResult6, (Purchase) null);
            }
        }
        return true;
    }
    ...
    public Inventory queryInventory(boolean z, List<String> list, List<String> list2) throws IabException {
        ...
        try {
            ...
            if (queryPurchases != 0) {
            ...
            } else if (!z || (querySkuDetails2 = querySkuDetails(ITEM_TYPE_INAPP, inventory, list)) == 0) {
                if (this.mSubscriptionsSupported) {
                    ...
                    } else if (z && (querySkuDetails = querySkuDetails(ITEM_TYPE_SUBS, inventory, list2)) != 0) {
    ...
    public void flagEndAsync() {
        ...
        L_0x0029:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: util.IabHelper.flagEndAsync():void");
    }
