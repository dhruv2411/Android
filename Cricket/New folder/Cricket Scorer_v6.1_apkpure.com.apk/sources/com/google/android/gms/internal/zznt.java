...
public interface zznt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznt {
        ...
        private static class C0088zza implements zznt {
        ...
        public static zznt zzag(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznt)) ? new C0088zza(iBinder) : (zznt) queryLocalInterface;
        }
