...
public interface zzab extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzab {
        ...
        private static class C0108zza implements zzab {
        ...
        public static zzab zzdW(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzab)) ? new C0108zza(iBinder) : (zzab) queryLocalInterface;
        }
