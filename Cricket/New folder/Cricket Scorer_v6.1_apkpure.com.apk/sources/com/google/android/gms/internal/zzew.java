...
public interface zzew extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzew {
        ...
        private static class C0054zza implements zzew {
        ...
        public static zzew asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzew)) ? new C0054zza(iBinder) : (zzew) queryLocalInterface;
        }
