...
public interface zzes extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzes {
        ...
        private static class C0050zza implements zzes {
        ...
        public static zzes zzp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzes)) ? new C0050zza(iBinder) : (zzes) queryLocalInterface;
        }
