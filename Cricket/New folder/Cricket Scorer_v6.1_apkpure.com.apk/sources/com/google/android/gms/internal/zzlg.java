...
public interface zzlg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlg {
        ...
        private static class C0083zza implements zzlg {
        ...
        public static zzlg zzZ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlg)) ? new C0083zza(iBinder) : (zzlg) queryLocalInterface;
        }
