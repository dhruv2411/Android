...
public interface zzep extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzep {
        ...
        private static class C0047zza implements zzep {
        ...
        public static zzep zzm(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzep)) ? new C0047zza(iBinder) : (zzep) queryLocalInterface;
        }
