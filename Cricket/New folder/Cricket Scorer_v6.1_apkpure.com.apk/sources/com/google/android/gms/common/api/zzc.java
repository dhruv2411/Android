...
public abstract class zzc<O extends Api.ApiOptions> {
    ...
    public static class zza {
        public static final zza zzayY = new C0013zza().zzvk();
        ...
        public static class C0013zza {
            private zzabs zzayW;
            private Looper zzrs;

            public C0013zza zza(zzabs zzabs) {
                zzac.zzb(zzabs, (Object) "StatusExceptionMapper must not be null.");
                this.zzayW = zzabs;
                return this;
            }

            public C0013zza zzb(Looper looper) {
    ...
    public zzc(@NonNull Activity activity, Api<O> api, O o, Looper looper, zzabs zzabs) {
        this(activity, api, o, new zza.C0013zza().zzb(looper).zza(zzabs).zzvk());
    }
    ...
    public zzc(@NonNull Activity activity, Api<O> api, O o, zzabs zzabs) {
        this(activity, api, o, new zza.C0013zza().zza(zzabs).zzb(activity.getMainLooper()).zzvk());
    }
    ...
    public zzc(@NonNull Context context, Api<O> api, O o, Looper looper, zzabs zzabs) {
        this(context, api, o, new zza.C0013zza().zzb(looper).zza(zzabs).zzvk());
    }
    ...
    public zzc(@NonNull Context context, Api<O> api, O o, zzabs zzabs) {
        this(context, api, o, new zza.C0013zza().zza(zzabs).zzvk());
    }
