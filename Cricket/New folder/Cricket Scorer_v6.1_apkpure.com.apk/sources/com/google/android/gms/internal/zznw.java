...
public interface zznw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznw {
        ...
        private static class C0091zza implements zznw {
        ...
        public static zznw zzaj(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznw)) ? new C0091zza(iBinder) : (zznw) queryLocalInterface;
        }
