...
public class zzek {
    ...
    public zzet zza(final Context context, final zzeg zzeg, final String str) {
        return (zzet) zza(context, false, new zza<zzet>() {
            ...
            public zzet zzb(zzew zzew) throws RemoteException {
                return zzew.createSearchAdManager(zzd.zzA(context), zzeg, str, zzg.GOOGLE_PLAY_SERVICES_VERSION_CODE);
            }
            ...
            public zzet zzeJ() {
                ...
                zzek.this.zzc(context, FirebaseAnalytics.Event.SEARCH);
                return new zzfl();
            }
        });
    }
    ...
    public zzet zza(Context context, zzeg zzeg, String str, zzka zzka) {
        ...
        return (zzet) zza(context, false, new zza<zzet>() {
            /* renamed from: zza */
            public zzet zzb(zzew zzew) throws RemoteException {
                return zzew.createBannerAdManager(zzd.zzA(context2), zzeg2, str2, zzka2, zzg.GOOGLE_PLAY_SERVICES_VERSION_CODE);
            }
    ...
    public zznu zza(final Context context, final zzka zzka) {
        return (zznu) zza(context, false, new zza<zznu>() {
            ...
            public zznu zzb(zzew zzew) throws RemoteException {
                return zzew.createRewardedVideoAd(zzd.zzA(context), zzka, zzg.GOOGLE_PLAY_SERVICES_VERSION_CODE);
            }
        });
    }
    ...
    public zzer zzb(final Context context, final String str, final zzka zzka) {
        return (zzer) zza(context, false, new zza<zzer>() {
            ...
            public zzer zzb(zzew zzew) throws RemoteException {
                return zzew.createAdLoaderBuilder(zzd.zzA(context), str, zzka, zzg.GOOGLE_PLAY_SERVICES_VERSION_CODE);
            }
    ...
    public zzet zzb(Context context, zzeg zzeg, String str, zzka zzka) {
        ...
        return (zzet) zza(context, false, new zza<zzet>() {
            /* renamed from: zza */
            public zzet zzb(zzew zzew) throws RemoteException {
                return zzew.createInterstitialAdManager(zzd.zzA(context2), zzeg2, str2, zzka2, zzg.GOOGLE_PLAY_SERVICES_VERSION_CODE);
            }
    ...
    public zzey zzl(final Context context) {
        return (zzey) zza(context, false, new zza<zzey>() {
            ...
            public zzey zzb(zzew zzew) throws RemoteException {
                return zzew.getMobileAdsSettingsManagerWithClientJarVersion(zzd.zzA(context), zzg.GOOGLE_PLAY_SERVICES_VERSION_CODE);
            }
