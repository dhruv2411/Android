...
public class zzzu extends zza {
    ...
    public String toString() {
        return "PlayLoggerContext[" + "package=" + this.packageName + ',' + "packageVersionCode=" + this.zzaxZ + ',' + "logSource=" + this.zzaya + ',' + "logSourceName=" + this.zzaye + ',' + "uploadAccount=" + this.zzayb + ',' + "loggingId=" + this.zzayc + ',' + "logAndroidId=" + this.zzayd + ',' + "isAnonymous=" + this.zzayf + ',' + "qosTier=" + this.zzayg + "]";
    }
