...
public interface zzeu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeu {
        ...
        private static class C0052zza implements zzeu {
        ...
        public static zzeu zzr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeu)) ? new C0052zza(iBinder) : (zzeu) queryLocalInterface;
        }
