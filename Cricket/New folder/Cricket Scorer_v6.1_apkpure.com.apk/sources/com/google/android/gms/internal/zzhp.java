...
public interface zzhp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhp {
        ...
        private static class C0068zza implements zzhp {
        ...
        public static zzhp zzH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhp)) ? new C0068zza(iBinder) : (zzhp) queryLocalInterface;
        }
