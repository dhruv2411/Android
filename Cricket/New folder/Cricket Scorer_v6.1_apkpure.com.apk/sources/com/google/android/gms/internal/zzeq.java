...
public interface zzeq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeq {
        ...
        private static class C0048zza implements zzeq {
        ...
        public static zzeq zzn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeq)) ? new C0048zza(iBinder) : (zzeq) queryLocalInterface;
        }
