...
public class zzjh implements zzjf {
    ...
    public void zzam(String str) {
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                zzjh.this.zzIs.loadData(format, AudienceNetworkActivity.WEBVIEW_MIME_TYPE, "UTF-8");
            }
        });
    }
    ...
    public void zzao(final String str) {
        runOnUiThread(new Runnable() {
            public void run() {
                zzjh.this.zzIs.loadData(str, AudienceNetworkActivity.WEBVIEW_MIME_TYPE, "UTF-8");
            }
        });
    }
