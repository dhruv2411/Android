...
public interface zzev extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzev {
        ...
        private static class C0053zza implements zzev {
        ...
        public static zzev zzs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzev)) ? new C0053zza(iBinder) : (zzev) queryLocalInterface;
        }
