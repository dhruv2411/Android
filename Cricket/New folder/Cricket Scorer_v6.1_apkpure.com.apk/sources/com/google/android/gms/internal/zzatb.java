...
public class zzatb extends zzaug {
        ...
        if (num != null) {
            ...
            if (intValue == 0) {
                ...
                if (l == null) {
                    ...
                    zza(str, j - l.longValue(), (AppMeasurement.zzf) zzMU);
                }
                if (!this.zzbqm.isEmpty()) {
                    return;
                }
                ...
                zza(j - this.zzbqn, (AppMeasurement.zzf) zzMU);
                this.zzbqn = 0;
                return;
            }
    ...
    public void zzW(long j) {
        zzauk.zza zzMU = zzKe().zzMU();
        for (String next : this.zzbql.keySet()) {
            zza(next, j - this.zzbql.get(next).longValue(), (AppMeasurement.zzf) zzMU);
        }
        if (!this.zzbql.isEmpty()) {
            zza(j - this.zzbqn, (AppMeasurement.zzf) zzMU);
        }
