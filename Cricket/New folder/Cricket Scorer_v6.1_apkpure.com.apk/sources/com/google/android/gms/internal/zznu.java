...
public interface zznu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznu {
        ...
        private static class C0089zza implements zznu {
        ...
        public static zznu zzah(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznu)) ? new C0089zza(iBinder) : (zznu) queryLocalInterface;
        }
