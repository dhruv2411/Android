...
public interface zzack extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzack {
        ...
        private static class C0034zza implements zzack {
        ...
        public static zzack zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzack)) ? new C0034zza(iBinder) : (zzack) queryLocalInterface;
        }
