...
public interface zzkc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkc {
        ...
        private static class C0074zza implements zzkc {
        ...
        public static zzkc zzO(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkc)) ? new C0074zza(iBinder) : (zzkc) queryLocalInterface;
        }
