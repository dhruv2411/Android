...
public abstract class zzc extends zzb implements zzi, zzkx {
    ...
    public zzqw zza(zzpb.zza zza, @Nullable zzf zzf, @Nullable zzot zzot) {
        ...
        if (nextView instanceof zzqw) {
            zzqw zzqw2 = (zzqw) nextView;
            if (zzgd.zzCI.get().booleanValue()) {
                zzpk.zzbf("Reusing webview...");
                zzqw2.zza(this.zzss.zzqn, this.zzss.zzvr, this.zzsn);
                zzqw = zzqw2;
            } else {
                zzqw2.destroy();
            }
        ...
        zzqw zzqw3 = zzqw;
        zzqw3.zzlv().zza(this, this, this, this, false, this, (zzih) null, zzf, this, zzot);
        zza((zzjj) zzqw3);
        zzqw3.zzbj(zza.zzTi.zzRL);
        return zzqw3;
    }
