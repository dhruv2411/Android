...
public class AppMeasurement {
    ...
    public String getAppInstanceId() {
        return this.zzbqc.zzKa().zzfQ((String) null);
    }
    ...
    public void logEvent(@Size(max = 40, min = 1) @NonNull String str, Bundle bundle) {
        ...
        if ("_iap".equals(str) || (zzfU = this.zzbqc.zzKh().zzfU(str)) == 0) {
            this.zzbqc.zzKa().zza(SettingsJsonConstants.APP_KEY, str, bundle, true);
        } else {
    ...
    public void setUserId(String str) {
        zzb(SettingsJsonConstants.APP_KEY, "_id", str);
    }
    ...
    public void zza(String str, String str2, Bundle bundle, long j) {
        ...
        this.zzbqc.zzKa().zzd(str, str2, bundle, j);
    }
