...
public class zzb {
    ...
    public Bundle zza(String str, String str2, String str3) {
        try {
            ...
            return (Bundle) loadClass.getDeclaredMethod("getBuyIntent", new Class[]{Integer.TYPE, String.class, String.class, String.class, String.class}).invoke(loadClass.cast(this.zzPq), new Object[]{3, str, str2, IabHelper.ITEM_TYPE_INAPP, str3});
        } catch (Exception e) {
            if (!this.zzPr) {
                return null;
            }
    ...
    public Bundle zzn(String str, String str2) {
        try {
            Class<?> loadClass = this.mContext.getClassLoader().loadClass("com.android.vending.billing.IInAppBillingService");
            return (Bundle) loadClass.getDeclaredMethod("getPurchases", new Class[]{Integer.TYPE, String.class, String.class, String.class}).invoke(loadClass.cast(this.zzPq), new Object[]{3, str, IabHelper.ITEM_TYPE_INAPP, str2});
        } catch (Exception e) {
            if (!this.zzPr) {
                return null;
            }
