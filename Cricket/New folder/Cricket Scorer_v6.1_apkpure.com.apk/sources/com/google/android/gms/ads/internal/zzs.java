    ...
    public boolean zza(zzpb zzpb, zzpb zzpb2) {
        ...
        if (zzpb2.zzSn) {
            try {
                ...
                if (zzpb2.zzLj != null) {
                    zzkf = zzpb2.zzLj.zzhd();
                }
                if (zzhc != null && this.zzss.zzvB != null) {
                    zzgv zza = zza(zzhc);
                    zza.zzb(new zzgz(this.zzss.zzqn, this, this.zzss.zzvm, zzhc, (zzha.zza) zza));
                    zza(zza);
                } else if (zzkf == null || this.zzss.zzvC == null) {
                    zzpk.zzbh("No matching mapper/listener for retrieved native ad template.");
                    zzh(0);
                    return false;
                } else {
                    zzgw zza2 = zza(zzkf);
                    zza2.zzb(new zzgz(this.zzss.zzqn, this, this.zzss.zzvm, zzkf, (zzha.zza) zza2));
                    zza(zza2);
                }
            } catch (RemoteException e) {
            ...
            if ((zza3 instanceof zzgw) && this.zzss.zzvC != null) {
                ...
                if ((zza3 instanceof zzgx) && this.zzss.zzvE != null) {
                    zzgx zzgx = (zzgx) zza3;
                    if (this.zzss.zzvE.get(zzgx.getCustomTemplateId()) != null) {
                        zza(zzpb2, zzgx.getCustomTemplateId());
                    }
                }
