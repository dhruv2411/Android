...
class zzg<TResult> {
    ...
    public void zza(@android.support.annotation.NonNull com.google.android.gms.tasks.Task<TResult> r3) {
        /*
            ...
            monitor-enter(r0)
            java.util.Queue<com.google.android.gms.tasks.zzf<TResult>> r1 = r2.zzbNA     // Catch:{ all -> 0x002c }
            if (r1 == 0) goto L_0x002a
            boolean r1 = r2.zzbNB     // Catch:{ all -> 0x002c }
            if (r1 == 0) goto L_0x000c
            goto L_0x002a
        L_0x000c:
            r1 = 1
            r2.zzbNB = r1     // Catch:{ all -> 0x002c }
            monitor-exit(r0)     // Catch:{ all -> 0x002c }
        L_0x0010:
            java.lang.Object r1 = r2.zzrJ
            monitor-enter(r1)
            java.util.Queue<com.google.android.gms.tasks.zzf<TResult>> r0 = r2.zzbNA     // Catch:{ all -> 0x0027 }
            java.lang.Object r0 = r0.poll()     // Catch:{ all -> 0x0027 }
            com.google.android.gms.tasks.zzf r0 = (com.google.android.gms.tasks.zzf) r0     // Catch:{ all -> 0x0027 }
            if (r0 != 0) goto L_0x0022
            r3 = 0
            r2.zzbNB = r3     // Catch:{ all -> 0x0027 }
