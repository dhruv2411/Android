...
public interface zzfa extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfa {
        ...
        private static class C0058zza implements zzfa {
        ...
        public static zzfa zzw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfa)) ? new C0058zza(iBinder) : (zzfa) queryLocalInterface;
        }
