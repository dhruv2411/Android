...
public interface zzez extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzez {
        ...
        private static class C0057zza implements zzez {
        ...
        public static zzez zzv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzez)) ? new C0057zza(iBinder) : (zzez) queryLocalInterface;
        }
