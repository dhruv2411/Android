...
public interface zzey extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzey {
        ...
        private static class C0056zza implements zzey {
        ...
        public static zzey zzu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzey)) ? new C0056zza(iBinder) : (zzey) queryLocalInterface;
        }
