...
public class zzkq extends zzkw {
    ...
    private void zzhj() {
        this.zzLS = zzaw(DublinCoreProperties.DESCRIPTION);
        this.zzLV = zzaw("summary");
        this.zzLT = zzax("start_ticks");
        this.zzLU = zzax("end_ticks");
        this.zzLW = zzaw(FirebaseAnalytics.Param.LOCATION);
    }
    ...
    public Intent createIntent() {
        ...
        data.putExtra(DublinCoreProperties.DESCRIPTION, this.zzLV);
        if (this.zzLT > -1) {
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzM.setPositiveButton(resources != null ? resources.getString(R.string.accept) : "Accept", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    zzw.zzcM().zzb(zzkq.this.mContext, zzkq.this.createIntent());
                }
            });
            zzM.setNegativeButton(resources != null ? resources.getString(R.string.decline) : "Decline", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
