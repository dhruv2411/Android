...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        private static class C0137zza implements zzy {
        ...
        public static zzy zzdT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C0137zza(iBinder) : (zzy) queryLocalInterface;
        }
