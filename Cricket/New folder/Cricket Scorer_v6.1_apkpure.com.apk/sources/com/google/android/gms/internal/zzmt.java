...
public interface zzmt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmt {
        ...
        private static class C0086zza implements zzmt {
        ...
        public static zzmt zzae(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmt)) ? new C0086zza(iBinder) : (zzmt) queryLocalInterface;
        }
