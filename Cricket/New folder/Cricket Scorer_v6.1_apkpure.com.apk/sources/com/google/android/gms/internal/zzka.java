...
public interface zzka extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzka {
        ...
        private static class C0072zza implements zzka {
        ...
        public static zzka zzM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzka)) ? new C0072zza(iBinder) : (zzka) queryLocalInterface;
        }
