...
public interface zzhq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhq {
        ...
        private static class C0069zza implements zzhq {
        ...
        public static zzhq zzI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhq)) ? new C0069zza(iBinder) : (zzhq) queryLocalInterface;
        }
