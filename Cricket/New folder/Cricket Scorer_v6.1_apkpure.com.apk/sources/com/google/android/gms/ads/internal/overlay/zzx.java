...
class zzx implements SensorEventListener {
    ...
    public void zza(float[] fArr) {
        if (fArr[0] != 0.0f || fArr[1] != 0.0f || fArr[2] != 0.0f) {
            ...
            switch (getRotation()) {
                case 1:
                    SensorManager.remapCoordinateSystem(this.zzOr, 2, TsExtractor.TS_STREAM_TYPE_AC3, this.zzOs);
                    break;
                case 2:
                    SensorManager.remapCoordinateSystem(this.zzOr, TsExtractor.TS_STREAM_TYPE_AC3, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, this.zzOs);
                    break;
                case 3:
                    SensorManager.remapCoordinateSystem(this.zzOr, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, 1, this.zzOs);
                    break;
                default:
