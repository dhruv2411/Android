...
public interface zzgo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgo {
        ...
        private static class C0060zza implements zzgo {
        ...
        public static zzgo zzz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgo)) ? new C0060zza(iBinder) : (zzgo) queryLocalInterface;
        }
