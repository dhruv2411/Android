...
public interface zzaqm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaqm {
        ...
        private static class C0038zza implements zzaqm {
        ...
        public static zzaqm zzcU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaqm)) ? new C0038zza(iBinder) : (zzaqm) queryLocalInterface;
        }
