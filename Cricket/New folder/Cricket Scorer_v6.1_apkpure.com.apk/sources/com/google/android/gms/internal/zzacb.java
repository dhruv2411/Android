...
public final class zzacb extends Drawable implements Drawable.Callback {
    ...
    private static final class zza extends Drawable {
        ...
        private static final C0033zza zzaER = new C0033zza();

        /* renamed from: com.google.android.gms.internal.zzacb$zza$zza  reason: collision with other inner class name */
        private static final class C0033zza extends Drawable.ConstantState {
            private C0033zza() {
            }
    ...
    public zzacb(Drawable drawable, Drawable drawable2) {
        ...
        zzb zzb2 = this.zzaEJ;
        zzb2.zzaES = drawable.getChangingConfigurations() | zzb2.zzaES;
        drawable2 = drawable2 == null ? zza.zzaEQ : drawable2;
        this.zzaEL = drawable2;
        drawable2.setCallback(this);
        zzb zzb3 = this.zzaEJ;
        zzb3.zzaES = drawable2.getChangingConfigurations() | zzb3.zzaES;
    }
        ...
        switch (this.zzaED) {
            ...
            case 2:
                if (this.zzafe >= 0) {
                    ...
                    this.zzaEH = (int) (0.0f + (((float) (this.zzaEE - 0)) * Math.min(uptimeMillis, 1.0f)));
                    break;
                }
                break;
        }
