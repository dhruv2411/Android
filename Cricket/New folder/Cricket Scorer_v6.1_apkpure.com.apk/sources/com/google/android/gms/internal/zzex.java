...
public interface zzex extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzex {
        ...
        private static class C0055zza implements zzex {
        ...
        public static zzex zzt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzex)) ? new C0055zza(iBinder) : (zzex) queryLocalInterface;
        }
