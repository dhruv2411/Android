...
public final class zzabu extends Fragment implements zzabf {
    ...
    public static zzabu zza(FragmentActivity fragmentActivity) {
        ...
        try {
            zzabu zzabu2 = (zzabu) fragmentActivity.getSupportFragmentManager().findFragmentByTag("SupportLifecycleFragmentImpl");
            if (zzabu2 == null || zzabu2.isRemoving()) {
                zzabu2 = new zzabu();
                fragmentActivity.getSupportFragmentManager().beginTransaction().add((Fragment) zzabu2, "SupportLifecycleFragmentImpl").commitAllowingStateLoss();
            }
            zzaCS.put(fragmentActivity, new WeakReference(zzabu2));
            return zzabu2;
