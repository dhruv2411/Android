...
public class zzg extends zzc implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public zzec zze(zzec zzec) {
        zzec zzec2 = zzec;
        if (zzec2.zzyY == this.zzsS) {
            return zzec2;
        }
        return new zzec(zzec2.versionCode, zzec2.zzyT, zzec2.extras, zzec2.zzyU, zzec2.zzyV, zzec2.zzyW, zzec2.zzyX, zzec2.zzyY || this.zzsS, zzec2.zzyZ, zzec2.zzza, zzec2.zzzb, zzec2.zzzc, zzec2.zzzd, zzec2.zzze, zzec2.zzzf, zzec2.zzzg, zzec2.zzzh, zzec2.zzzi);
    }
