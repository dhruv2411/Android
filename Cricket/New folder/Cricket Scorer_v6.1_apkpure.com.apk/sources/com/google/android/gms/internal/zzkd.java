...
public interface zzkd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkd {
        ...
        private static class C0075zza implements zzkd {
        ...
        public static zzkd zzP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkd)) ? new C0075zza(iBinder) : (zzkd) queryLocalInterface;
        }
