    ...
    static HttpUriRequest zzb(zzl<?> zzl, Map<String, String> map) throws zza {
        switch (zzl.getMethod()) {
            case -1:
                ...
                httpPost.addHeader(HttpRequest.HEADER_CONTENT_TYPE, zzl.zzi());
            ...
            case 1:
                ...
                httpPost2.addHeader(HttpRequest.HEADER_CONTENT_TYPE, zzl.zzl());
                zza((HttpEntityEnclosingRequestBase) httpPost2, zzl);
                return httpPost2;
            case 2:
                HttpPut httpPut = new HttpPut(zzl.getUrl());
                httpPut.addHeader(HttpRequest.HEADER_CONTENT_TYPE, zzl.zzl());
            ...
            case 7:
                ...
                zza2.addHeader(HttpRequest.HEADER_CONTENT_TYPE, zzl.zzl());
