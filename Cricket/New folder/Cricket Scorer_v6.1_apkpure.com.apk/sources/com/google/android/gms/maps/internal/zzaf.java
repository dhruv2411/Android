...
public interface zzaf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaf {
        ...
        private static class C0112zza implements zzaf {
        ...
        public static zzaf zzea(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaf)) ? new C0112zza(iBinder) : (zzaf) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                zza(IStreetViewPanoramaDelegate.zza.zzed(parcel.readStrongBinder()));
