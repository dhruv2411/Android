...
public interface zzli extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzli {
        ...
        private static class C0085zza implements zzli {
        ...
        public static zzli zzab(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzli)) ? new C0085zza(iBinder) : (zzli) queryLocalInterface;
        }
