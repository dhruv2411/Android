            ...
            try {
                ...
                if (list != null) {
                    if (!list.isEmpty()) {
                        ...
                        zzkf zzhd = zzpb.zzLj != null ? zzpb.zzLj.zzhd() : null;
                        if (list.contains("2") && zzhc != null) {
                            ...
                            zzhd.zzm(zzd.zzA(view));
                            if (!zzhd.getOverrideImpressionRecording()) {
                                zzhd.recordImpression();
                            }
                            zzqw.zzlv().zza("/nativeExpressViewClicked", zza((zzke) null, zzhd, zza));
                            return;
                        }
                    }
                }
        ...
        zzqw.zzlv().zza((zzqx.zza) new zzqx.zza() {
            public void zza(zzqw zzqw, boolean z) {
                try {
                    ...
                    jSONObject.put(FirebaseAnalytics.Param.PRICE, zzgv.this.getPrice());
                    jSONObject.put("star_rating", String.valueOf(zzgv.this.getStarRating()));
                    jSONObject.put("store", zzgv.this.getStore());
                    jSONObject.put(SettingsJsonConstants.APP_ICON_KEY, zzp.zza(zzgv.this.zzfQ()));
    ...
    private static boolean zzb(zzqw zzqw, zzjv zzjv, CountDownLatch countDownLatch) throws RemoteException {
        ...
        if (view == null) {
            ...
            if (list == null || list.isEmpty()) {
                ...
                String str2 = zzjv.zzLi.zzKy;
                String str3 = zzjv.zzLi.zzKz;
                if (str3 != null) {
                    zzqw.loadDataWithBaseURL(str3, str2, AudienceNetworkActivity.WEBVIEW_MIME_TYPE, "UTF-8", (String) null);
                    return true;
                }
                zzqw.loadData(str2, AudienceNetworkActivity.WEBVIEW_MIME_TYPE, "UTF-8");
                return true;
            }
        }
        zzpk.zzbh(str);
