...
public class zzgx extends zzhn.zza implements zzha.zza {
    ...
    public List<String> getAvailableAssetNames() {
        ...
        int i2 = 0;
        int i3 = 0;
        while (i2 < this.zzGE.size()) {
            strArr[i3] = this.zzGE.keyAt(i2);
            i2++;
            i3++;
        }
        while (i < this.zzGF.size()) {
            strArr[i3] = this.zzGF.keyAt(i);
            i++;
            i3++;
        }
    ...
    public boolean zzj(IObjectWrapper iObjectWrapper) {
        if (this.zzGA == null) {
            ...
            this.zzGA.zza((View) (FrameLayout) zzd.zzF(iObjectWrapper), (zzgy) r0);
            return true;
        }
    }
}
