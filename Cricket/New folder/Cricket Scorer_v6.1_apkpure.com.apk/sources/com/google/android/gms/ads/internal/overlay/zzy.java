...
public class zzy extends Thread implements SurfaceTexture.OnFrameAvailableListener, zzx.zza {
    ...
    private void zzio() {
        ...
        if (this.zzrC > this.zzrD) {
            ...
            f = (0.87266463f * ((float) this.zzrD)) / ((float) this.zzrC);
        } else {
    ...
    private EGLConfig zzis() {
        ...
        if (this.zzOP.eglChooseConfig(this.zzOQ, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12325, 16, 12344}, eGLConfigArr, 1, iArr) && iArr[0] > 0) {
    ...
    public void zzb(float f, float f2) {
        ...
        int i;
        if (this.zzrC > this.zzrD) {
            f3 = (f * 1.7453293f) / ((float) this.zzrC);
            f4 = 1.7453293f * f2;
            i = this.zzrC;
        } else {
            f3 = (f * 1.7453293f) / ((float) this.zzrD);
            f4 = 1.7453293f * f2;
            i = this.zzrD;
        }
        float f5 = f4 / ((float) i);
    ...
    public boolean zzir() {
        ...
        if (!this.zzOP.eglInitialize(this.zzOQ, new int[2]) || (zzis = zzis()) == null) {
            return false;
        }
        ...
        return (this.zzOS == null || this.zzOS == EGL10.EGL_NO_SURFACE || !this.zzOP.eglMakeCurrent(this.zzOQ, this.zzOS, this.zzOS, this.zzOR)) ? false : true;
    }
    ...
    public boolean zziv() {
        ...
        if (!(this.zzOS == null || this.zzOS == EGL10.EGL_NO_SURFACE)) {
            z = this.zzOP.eglDestroySurface(this.zzOQ, this.zzOS) | this.zzOP.eglMakeCurrent(this.zzOQ, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_CONTEXT) | false;
            this.zzOS = null;
        }
        if (this.zzOR != null) {
