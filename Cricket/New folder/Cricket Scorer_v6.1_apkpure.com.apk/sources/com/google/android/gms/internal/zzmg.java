...
public class zzmg extends zzpj implements zzmh.zza {
    ...
    public void zzd(int i, String str) {
        ...
        this.zzPS = this.zzPS == null ? new zzmn(i2) : new zzmn(i2, this.zzPS.zzKL);
        this.zzRl.zza(new zzpb.zza(this.zzLo != null ? this.zzLo : new zzmk(this.zzRm, -1, (String) null, (String) null, (String) null), this.zzPS, this.zzKY, (zzeg) null, i2, -1, this.zzPS.zzSr, (JSONObject) null));
    }
    ...
    public void zza(@NonNull zzmn zzmn) {
        ...
        try {
            ...
            int i = this.zzPS.errorCode;
            StringBuilder sb = new StringBuilder(66);
            sb.append("There was a problem getting an ad response. ErrorCode: ");
            sb.append(i);
            throw new zza(sb.toString(), this.zzPS.errorCode);
        } catch (zza e2) {
