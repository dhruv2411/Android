...
public interface zzhl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhl {
        ...
        private static class C0066zza implements zzhl {
        ...
        public static zzhl zzF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhl)) ? new C0066zza(iBinder) : (zzhl) queryLocalInterface;
        }
