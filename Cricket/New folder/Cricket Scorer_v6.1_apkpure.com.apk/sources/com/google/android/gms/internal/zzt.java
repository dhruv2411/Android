...
public class zzt {
    ...
    static class zza {
        ...
        private final List<C0093zza> zzak = new ArrayList();
        ...
        private static class C0093zza {
            public final String name;
            public final long time;
            public final long zzam;

            public C0093zza(String str, long j, long j2) {
                this.name = str;
                this.zzam = j;
                this.time = j2;
            }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzak.add(new C0093zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            if (totalDuration > 0) {
                ...
                for (C0093zza next : this.zzak) {
                    long j2 = next.time;
                    zzt.zzb("(+%-4d) [%2d] %s", Long.valueOf(j2 - j), Long.valueOf(next.zzam), next.name);
                    j = j2;
                }
            }
        }
