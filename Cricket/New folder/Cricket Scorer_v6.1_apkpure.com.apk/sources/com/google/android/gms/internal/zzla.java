...
public interface zzla extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzla {
        ...
        private static class C0079zza implements zzla {
        ...
        public static zzla zzU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzla)) ? new C0079zza(iBinder) : (zzla) queryLocalInterface;
        }
