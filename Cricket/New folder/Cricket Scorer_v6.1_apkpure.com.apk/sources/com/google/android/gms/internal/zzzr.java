...
public interface zzzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzzr {
        ...
        private static class C0095zza implements zzzr {
        ...
        public static zzzr zzbn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzzr)) ? new C0095zza(iBinder) : (zzzr) queryLocalInterface;
        }
