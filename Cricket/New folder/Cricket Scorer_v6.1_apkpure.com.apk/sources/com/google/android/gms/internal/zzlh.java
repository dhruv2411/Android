...
public interface zzlh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlh {
        ...
        private static class C0084zza implements zzlh {
        ...
        public static zzlh zzaa(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlh)) ? new C0084zza(iBinder) : (zzlh) queryLocalInterface;
        }
