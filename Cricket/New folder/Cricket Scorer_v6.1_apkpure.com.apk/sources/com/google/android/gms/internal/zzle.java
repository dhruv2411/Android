...
public interface zzle extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzle {
        ...
        private static class C0081zza implements zzle {
        ...
        public static zzle zzX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzle)) ? new C0081zza(iBinder) : (zzle) queryLocalInterface;
        }
