...
public class zzcy implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public void zzl(int i) {
        ...
        if (this.zzwX.size() != 0 && this.zzwU != null) {
            ...
            boolean z6 = !z5 && zzw.zzcM().zza(view, this.zzwp, this.zzwq) && z2 && z && windowVisibility == 0;
            if (z4 && !this.zzvT.tryAcquire() && z6 == this.zzww) {
                return;
            }
            if (z6 || this.zzww || i2 != 1) {
                long elapsedRealtime = zzw.zzcS().elapsedRealtime();
                boolean isScreenOn = this.zzwp.isScreenOn();
                if (view != null) {
                    z3 = zzw.zzcO().isAttachedToWindow(view);
                }
                zza zza2 = new zza(elapsedRealtime, isScreenOn, z3, view != null ? view.getWindowVisibility() : 8, zza(rect5), zza(rect), zza(rect2), z2, zza(rect3), z, zza(rect4), this.zzwY.density, z6);
