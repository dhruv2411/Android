...
public interface zzom extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzom {
        ...
        private static class C0092zza implements zzom {
        ...
        public static zzom zzal(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzom)) ? new C0092zza(iBinder) : (zzom) queryLocalInterface;
        }
