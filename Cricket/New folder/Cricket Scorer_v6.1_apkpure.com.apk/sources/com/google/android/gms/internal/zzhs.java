...
public interface zzhs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhs {
        ...
        private static class C0071zza implements zzhs {
        ...
        public static zzhs zzK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhs)) ? new C0071zza(iBinder) : (zzhs) queryLocalInterface;
        }
