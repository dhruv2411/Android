...
final class zzaai implements zzabc {
    ...
    private class zza implements zzabc.zza {
        ...
        public void zzc(int i, boolean z) {
            ...
            try {
                if (!zzaai.this.zzaAF && zzaai.this.zzaAE != null) {
                    if (zzaai.this.zzaAE.isSuccess()) {
                        boolean unused = zzaai.this.zzaAF = true;
                        zzaai.this.zzaAy.onConnectionSuspended(i);
                        zzaai.this.zzaAG.unlock();
                        return;
                    }
                }
                boolean unused2 = zzaai.this.zzaAF = false;
                zzaai.this.zzb(i, z);
            } finally {
                zzaai.this.zzaAG.unlock();
            }
    ...
    private zzaai(Context context, zzaat zzaat, Lock lock, Looper looper, zze zze, Map<Api.zzc<?>, Api.zze> map, Map<Api.zzc<?>, Api.zze> map2, zzg zzg, Api.zza<? extends zzbai, zzbaj> zza2, Api.zze zze2, ArrayList<zzaag> arrayList, ArrayList<zzaag> arrayList2, Map<Api<?>, Boolean> map3, Map<Api<?>, Boolean> map4) {
        ...
        zze zze3 = zze;
        zzaav zzaav = r3;
        zzaav zzaav2 = new zzaav(context3, this.zzaAw, lock3, looper2, zze3, map2, (zzg) null, map4, (Api.zza<? extends zzbai, zzbaj>) null, arrayList2, new zza());
        this.zzaAx = zzaav;
        this.zzaAy = new zzaav(context3, this.zzaAw, lock3, looper, zze3, map, zzg, map3, zza2, arrayList, new zzb());
