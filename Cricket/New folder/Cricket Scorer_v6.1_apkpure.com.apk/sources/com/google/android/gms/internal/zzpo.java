...
public class zzpo {
    ...
    private void zza(JSONArray jSONArray, Object obj) throws JSONException {
        if (obj instanceof Bundle) {
            ...
            obj = zzQ((Map<String, ?>) (Map) obj);
        } else if (obj instanceof Collection) {
            obj = zza((Collection<?>) (Collection) obj);
        ...
        try {
            ...
            while (true) {
                ...
                if (Process.myPid() == next.pid) {
                    return next.importance == 100 && !keyguardManager.inKeyguardRestrictedInputMode() && zzi(context);
                }
            }
    ...
    public Bitmap zzQ(Context context) {
        ...
        try {
            if (zzgd.zzEb.get().booleanValue()) {
                ...
                zzq = window != null ? zzr(window.getDecorView().getRootView()) : null;
            } else {
                zzq = zzq(((Activity) context).getWindow().getDecorView());
            }
            return zzq;
        } catch (RuntimeException e) {
    ...
    public Bundle zza(zzde zzde) {
        ...
        if (str != null && zzgd.zzCk.get().booleanValue() && !zzw.zzcQ().zzkh()) {
            bundle.putString("v_fp_vertical", str);
        }
        if (str3 != null && zzgd.zzCi.get().booleanValue() && !zzw.zzcQ().zzkg()) {
    ...
    public String zza(Context context, View view, zzeg zzeg) {
        ...
        try {
            ...
            jSONObject.put(HtmlTags.SIZE, jSONObject2);
            ...
            if (!zzeg.zzzz) {
                ...
                while (view != null) {
                    ...
                    if (parent != null) {
                        ...
                        jSONObject3.put(DublinCoreProperties.TYPE, parent.getClass().getName());
    ...
    public void zza(final Context context, final List<String> list) {
        if (context instanceof Activity) {
            ...
            if (!TextUtils.isEmpty(zzbya.zzcC(activity))) {
                if (list == null) {
                    zzpk.v("Cannot ping urls: empty list.");
                } else if (!zzgr.zzo(context)) {
                    zzpk.v("Cannot ping url because custom tabs is not supported");
                } else {
    ...
    public boolean zza(Activity activity, Configuration configuration) {
        ...
        int round = ((int) Math.round(((double) activity.getResources().getDisplayMetrics().density) + 0.5d)) * zzgd.zzFs.get().intValue();
        return zzb(i, zzb + dimensionPixelSize, round) && zzb(i2, zzb2, round);
    }
    ...
    public java.lang.String zzu(final android.content.Context r4, java.lang.String r5) {
        /*
            r3 = this;
            java.lang.Object r0 = r3.zzrJ
            monitor-enter(r0)
            java.lang.String r1 = r3.zzIA     // Catch:{ all -> 0x00a8 }
            if (r1 == 0) goto L_0x000b
            java.lang.String r4 = r3.zzIA     // Catch:{ all -> 0x00a8 }
            monitor-exit(r0)     // Catch:{ all -> 0x00a8 }
            return r4
        L_0x000b:
            if (r5 != 0) goto L_0x0013
            java.lang.String r4 = r3.zzkK()     // Catch:{ all -> 0x00a8 }
            monitor-exit(r0)     // Catch:{ all -> 0x00a8 }
            return r4
        L_0x0013:
            com.google.android.gms.internal.zzpp r1 = com.google.android.gms.ads.internal.zzw.zzcO()     // Catch:{ Exception -> 0x001d }
            java.lang.String r1 = r1.getDefaultUserAgent(r4)     // Catch:{ Exception -> 0x001d }
            r3.zzIA = r1     // Catch:{ Exception -> 0x001d }
        L_0x001d:
            java.lang.String r1 = r3.zzIA     // Catch:{ all -> 0x00a8 }
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch:{ all -> 0x00a8 }
            if (r1 == 0) goto L_0x006f
            com.google.android.gms.internal.zzqe r1 = com.google.android.gms.internal.zzel.zzeT()     // Catch:{ all -> 0x00a8 }
            boolean r1 = r1.zzlj()     // Catch:{ all -> 0x00a8 }
            if (r1 != 0) goto L_0x0069
            r1 = 0
            r3.zzIA = r1     // Catch:{ all -> 0x00a8 }
            android.os.Handler r1 = zzXC     // Catch:{ all -> 0x00a8 }
            com.google.android.gms.internal.zzpo$2 r2 = new com.google.android.gms.internal.zzpo$2     // Catch:{ all -> 0x00a8 }
            r2.<init>(r4)     // Catch:{ all -> 0x00a8 }
            r1.post(r2)     // Catch:{ all -> 0x00a8 }
        L_0x003c:
            java.lang.String r4 = r3.zzIA     // Catch:{ all -> 0x00a8 }
            if (r4 != 0) goto L_0x006f
            java.lang.Object r4 = r3.zzrJ     // Catch:{ InterruptedException -> 0x0046 }
            r4.wait()     // Catch:{ InterruptedException -> 0x0046 }
            goto L_0x003c
        L_0x0046:
            java.lang.String r4 = r3.zzkK()     // Catch:{ all -> 0x00a8 }
            r3.zzIA = r4     // Catch:{ all -> 0x00a8 }
            java.lang.String r4 = "Interrupted, use default user agent: "
            java.lang.String r1 = r3.zzIA     // Catch:{ all -> 0x00a8 }
            java.lang.String r1 = java.lang.String.valueOf(r1)     // Catch:{ all -> 0x00a8 }
            int r2 = r1.length()     // Catch:{ all -> 0x00a8 }
            if (r2 == 0) goto L_0x005f
            java.lang.String r4 = r4.concat(r1)     // Catch:{ all -> 0x00a8 }
            goto L_0x0065
        L_0x005f:
            java.lang.String r1 = new java.lang.String     // Catch:{ all -> 0x00a8 }
            r1.<init>(r4)     // Catch:{ all -> 0x00a8 }
            r4 = r1
        L_0x0065:
            com.google.android.gms.internal.zzpk.zzbh(r4)     // Catch:{ all -> 0x00a8 }
            goto L_0x003c
        L_0x0069:
            java.lang.String r4 = r3.zzL(r4)     // Catch:{ all -> 0x00a8 }
            r3.zzIA = r4     // Catch:{ all -> 0x00a8 }
        L_0x006f:
            java.lang.String r4 = r3.zzIA     // Catch:{ all -> 0x00a8 }
            java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x00a8 }
            r1 = 11
            java.lang.String r2 = java.lang.String.valueOf(r4)     // Catch:{ all -> 0x00a8 }
            int r2 = r2.length()     // Catch:{ all -> 0x00a8 }
            int r1 = r1 + r2
            java.lang.String r2 = java.lang.String.valueOf(r5)     // Catch:{ all -> 0x00a8 }
            int r2 = r2.length()     // Catch:{ all -> 0x00a8 }
            int r1 = r1 + r2
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x00a8 }
            r2.<init>(r1)     // Catch:{ all -> 0x00a8 }
            r2.append(r4)     // Catch:{ all -> 0x00a8 }
            java.lang.String r4 = " (Mobile; "
            r2.append(r4)     // Catch:{ all -> 0x00a8 }
            r2.append(r5)     // Catch:{ all -> 0x00a8 }
            java.lang.String r4 = ")"
            r2.append(r4)     // Catch:{ all -> 0x00a8 }
            java.lang.String r4 = r2.toString()     // Catch:{ all -> 0x00a8 }
            r3.zzIA = r4     // Catch:{ all -> 0x00a8 }
            java.lang.String r4 = r3.zzIA     // Catch:{ all -> 0x00a8 }
            monitor-exit(r0)     // Catch:{ all -> 0x00a8 }
            return r4
        L_0x00a8:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzpo.zzu(android.content.Context, java.lang.String):java.lang.String");
    }
