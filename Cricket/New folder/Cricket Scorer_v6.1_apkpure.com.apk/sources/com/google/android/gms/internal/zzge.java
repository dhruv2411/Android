...
public class zzge {
    ...
    public zzge(Context context, String str) {
        ...
        this.zzFz.put(HtmlTags.S, "gmob_sdk");
        this.zzFz.put("v", "3");
        this.zzFz.put("os", Build.VERSION.RELEASE);
        this.zzFz.put(CommonUtils.SDK, Build.VERSION.SDK);
        this.zzFz.put("device", zzw.zzcM().zzkN());
        this.zzFz.put(SettingsJsonConstants.APP_KEY, context.getApplicationContext() != null ? context.getApplicationContext().getPackageName() : context.getPackageName());
