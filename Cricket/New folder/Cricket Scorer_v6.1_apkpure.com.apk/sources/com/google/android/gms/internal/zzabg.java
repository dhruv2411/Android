...
public final class zzabg extends Fragment implements zzabf {
    ...
    public static zzabg zzt(Activity activity) {
        ...
        try {
            zzabg zzabg2 = (zzabg) activity.getFragmentManager().findFragmentByTag("LifecycleFragmentImpl");
            if (zzabg2 == null || zzabg2.isRemoving()) {
                zzabg2 = new zzabg();
                activity.getFragmentManager().beginTransaction().add(zzabg2, "LifecycleFragmentImpl").commitAllowingStateLoss();
            }
            zzaCS.put(activity, new WeakReference(zzabg2));
            return zzabg2;
