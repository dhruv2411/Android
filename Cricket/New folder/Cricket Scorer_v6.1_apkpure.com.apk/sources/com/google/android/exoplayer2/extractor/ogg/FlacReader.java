...
final class FlacReader extends StreamReader {
    ...
    public boolean readHeaders(ParsableByteArray parsableByteArray, long j, StreamReader.SetupData setupData) throws IOException, InterruptedException {
        ...
        if (this.streamInfo == null) {
            ...
            setupData.format = Format.createAudioSampleFormat((String) null, MimeTypes.AUDIO_FLAC, (String) null, -1, this.streamInfo.bitRate(), this.streamInfo.channels, this.streamInfo.sampleRate, Collections.singletonList(copyOfRange), (DrmInitData) null, 0, (String) null);
            return true;
    ...
    private int getFlacFrameBlockSize(ParsableByteArray parsableByteArray) {
        int i = (parsableByteArray.data[2] & AUDIO_PACKET_TYPE) >> 4;
        switch (i) {
            case 1:
