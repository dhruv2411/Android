...
public final class Util {
    ...
    public static boolean isLocalFileUri(Uri uri) {
        ...
        return TextUtils.isEmpty(scheme) || scheme.equals(Annotation.FILE);
    }
    ...
    public static DataSpec getRemainderDataSpec(DataSpec dataSpec, int i) {
        ...
        return new DataSpec(dataSpec.uri, dataSpec.position + ((long) i), dataSpec.length == -1 ? -1 : dataSpec.length - ((long) i), dataSpec.key, dataSpec.flags);
    }
