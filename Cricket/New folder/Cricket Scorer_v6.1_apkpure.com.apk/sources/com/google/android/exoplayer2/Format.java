...
public final class Format implements Parcelable {
    ...
    public static Format createTextSampleFormat(String str, String str2, String str3, int i, int i2, String str4, DrmInitData drmInitData2) {
        return createTextSampleFormat(str, str2, str3, i, i2, str4, -1, drmInitData2, Long.MAX_VALUE, Collections.emptyList());
    }
    ...
    public static Format createImageSampleFormat(String str, String str2, String str3, int i, List<byte[]> list, String str4, DrmInitData drmInitData2) {
        return new Format(str, (String) null, str2, str3, i, -1, -1, -1, -1.0f, -1, -1.0f, (byte[]) null, -1, (ColorInfo) null, -1, -1, -1, -1, -1, 0, str4, -1, Long.MAX_VALUE, list, drmInitData2, (Metadata) null);
    }
    ...
    public Format copyWithMaxInputSize(int i) {
        ...
        int i15 = i7;
        return new Format(str, str2, str3, str4, i2, i, i3, i4, f, i5, f2, bArr, i13, colorInfo3, i15, i8, i9, i10, i11, i12, str5, i14, j, list2, this.drmInitData, this.metadata);
    }
    ...
    public Format copyWithContainerInfo(String str, String str2, int i, int i2, int i3, int i4, String str3) {
        ...
        int i18 = i9;
        int i19 = i8;
        return new Format(str, str4, str5, str2, i, i5, i2, i3, f, i6, f2, bArr, i14, colorInfo3, i19, i18, i17, i16, i15, i4, str3, i13, j, list2, this.drmInitData, this.metadata);
    }
    ...
    public Format copyWithManifestFormatInfo(Format format) {
        ...
        return new Format(format2.id, this.containerMimeType, this.sampleMimeType, this.codecs == null ? format2.codecs : this.codecs, this.bitrate == -1 ? format2.bitrate : this.bitrate, this.maxInputSize, this.width, this.height, this.frameRate == -1.0f ? format2.frameRate : this.frameRate, this.rotationDegrees, this.pixelWidthHeightRatio, this.projectionData, this.stereoMode, this.colorInfo, this.channelCount, this.sampleRate, this.pcmEncoding, this.encoderDelay, this.encoderPadding, this.selectionFlags | format2.selectionFlags, this.language == null ? format2.language : this.language, this.accessibilityChannel, this.subsampleOffsetUs, this.initializationData, format2.drmInitData != null ? format2.drmInitData : this.drmInitData, this.metadata);
    }
    ...
    public Format copyWithGaplessInfo(int i, int i2) {
        ...
        List<byte[]> list = this.initializationData;
        List<byte[]> list2 = list;
        return new Format(str, str2, str3, str4, i3, i4, i5, i6, f, i7, f2, bArr, i13, colorInfo3, i9, i10, i11, i, i2, i12, str5, i14, j, list2, this.drmInitData, this.metadata);
    }
    ...
    public Format copyWithDrmInitData(DrmInitData drmInitData2) {
        ...
        List<byte[]> list = this.initializationData;
        List<byte[]> list2 = list;
        return new Format(str, str2, str3, str4, i, i2, i3, i4, f, i5, f2, bArr, i6, colorInfo3, i7, i8, i9, i10, i11, i12, str5, i13, j, list2, drmInitData2, this.metadata);
    }
    ...
    public Format copyWithMetadata(Metadata metadata2) {
        ...
        List<byte[]> list = this.initializationData;
        List<byte[]> list2 = list;
        return new Format(str, str2, str3, str4, i, i2, i3, i4, f, i5, f2, bArr, i6, colorInfo3, i7, i8, i9, i10, i11, i12, str5, i13, j, list2, this.drmInitData, metadata2);
    }
    ...
    public final MediaFormat getFrameworkMediaFormatV16() {
        ...
        mediaFormat.setString(Annotation.MIMETYPE, this.sampleMimeType);
        maybeSetStringV16(mediaFormat, DublinCoreProperties.LANGUAGE, this.language);
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            int i = 0;
            int hashCode2 = 31 * (((((((((((((((((((((((MetaDo.META_OFFSETWINDOWORG + (this.id == null ? 0 : this.id.hashCode())) * 31) + (this.containerMimeType == null ? 0 : this.containerMimeType.hashCode())) * 31) + (this.sampleMimeType == null ? 0 : this.sampleMimeType.hashCode())) * 31) + (this.codecs == null ? 0 : this.codecs.hashCode())) * 31) + this.bitrate) * 31) + this.width) * 31) + this.height) * 31) + this.channelCount) * 31) + this.sampleRate) * 31) + (this.language == null ? 0 : this.language.hashCode())) * 31) + this.accessibilityChannel) * 31) + (this.drmInitData == null ? 0 : this.drmInitData.hashCode()));
