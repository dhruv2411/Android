...
public abstract class SimpleDecoder<I extends DecoderInputBuffer, O extends OutputBuffer, E extends Exception> implements Decoder<I, O, E> {
    ...
    private boolean decode() throws java.lang.InterruptedException {
        /*
            ...
            monitor-enter(r0)
        L_0x0003:
            boolean r1 = r6.released     // Catch:{ all -> 0x0086 }
            if (r1 != 0) goto L_0x0013
            boolean r1 = r6.canDecodeBuffer()     // Catch:{ all -> 0x0086 }
            if (r1 != 0) goto L_0x0013
            java.lang.Object r1 = r6.lock     // Catch:{ all -> 0x0086 }
        ...
        L_0x0013:
            ...
            return r2
        L_0x001a:
            java.util.LinkedList<I> r1 = r6.queuedInputBuffers     // Catch:{ all -> 0x0086 }
            java.lang.Object r1 = r1.removeFirst()     // Catch:{ all -> 0x0086 }
            com.google.android.exoplayer2.decoder.DecoderInputBuffer r1 = (com.google.android.exoplayer2.decoder.DecoderInputBuffer) r1     // Catch:{ all -> 0x0086 }
            O[] r3 = r6.availableOutputBuffers     // Catch:{ all -> 0x0086 }
            int r4 = r6.availableOutputBufferCount     // Catch:{ all -> 0x0086 }
            r5 = 1
            int r4 = r4 - r5
            r6.availableOutputBufferCount = r4     // Catch:{ all -> 0x0086 }
            r3 = r3[r4]     // Catch:{ all -> 0x0086 }
            boolean r4 = r6.flushed     // Catch:{ all -> 0x0086 }
            r6.flushed = r2     // Catch:{ all -> 0x0086 }
            monitor-exit(r0)     // Catch:{ all -> 0x0086 }
        ...
        L_0x003c:
            ...
            r3.addFlag(r0)
        L_0x0047:
            java.lang.Exception r0 = r6.decode(r1, r3, r4)
            r6.exception = r0
            E r0 = r6.exception
        ...
        L_0x0059:
            ...
            monitor-enter(r4)
            boolean r0 = r6.flushed     // Catch:{ all -> 0x0083 }
            if (r0 == 0) goto L_0x0064
            r6.releaseOutputBufferInternal(r3)     // Catch:{ all -> 0x0083 }
            goto L_0x007e
        L_0x0064:
            boolean r0 = r3.isDecodeOnly()     // Catch:{ all -> 0x0083 }
            if (r0 == 0) goto L_0x0073
            int r0 = r6.skippedOutputBufferCount     // Catch:{ all -> 0x0083 }
            int r0 = r0 + r5
            r6.skippedOutputBufferCount = r0     // Catch:{ all -> 0x0083 }
            r6.releaseOutputBufferInternal(r3)     // Catch:{ all -> 0x0083 }
            goto L_0x007e
        L_0x0073:
            int r0 = r6.skippedOutputBufferCount     // Catch:{ all -> 0x0083 }
            r3.skippedOutputBufferCount = r0     // Catch:{ all -> 0x0083 }
            r6.skippedOutputBufferCount = r2     // Catch:{ all -> 0x0083 }
            java.util.LinkedList<O> r0 = r6.queuedOutputBuffers     // Catch:{ all -> 0x0083 }
            r0.addLast(r3)     // Catch:{ all -> 0x0083 }
        L_0x007e:
            r6.releaseInputBufferInternal(r1)     // Catch:{ all -> 0x0083 }
