...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
    ...
    public void configureCodec(MediaCodecInfo mediaCodecInfo, MediaCodec mediaCodec, Format format, MediaCrypto mediaCrypto) {
        ...
        if (this.passthroughEnabled) {
            ...
            this.passthroughMediaFormat.setString(Annotation.MIMETYPE, MimeTypes.AUDIO_RAW);
    ...
    public void onOutputFormatChanged(MediaCodec mediaCodec, MediaFormat mediaFormat) throws ExoPlaybackException {
        ...
        String string = z ? this.passthroughMediaFormat.getString(Annotation.MIMETYPE) : MimeTypes.AUDIO_RAW;
        if (z) {
