...
final class DvbParser {
    ...
    private static final byte[] defaultMap2To4 = {0, 7, 8, BidiOrder.B};
    private static final byte[] defaultMap2To8 = {0, 119, -120, -1};
    private static final byte[] defaultMap4To8 = {0, BidiOrder.WS, DocWriter.QUOTE, 51, 68, 85, 102, 119, -120, -103, -86, -69, -52, -35, -18, -1};
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i9 > 0) {
            ...
            iArr[readBits2] = getColor((byte) (255 - (i2 & 255)), Util.constrainValue((int) (d + (1.402d * d2)), 0, 255), Util.constrainValue((int) ((d - (0.34414d * d3)) - (0.71414d * d2)), 0, 255), Util.constrainValue((int) (d + (1.772d * d3)), 0, 255));
            i9 = i6;
            readBits = readBits;
            i7 = 8;
            i8 = 2;
