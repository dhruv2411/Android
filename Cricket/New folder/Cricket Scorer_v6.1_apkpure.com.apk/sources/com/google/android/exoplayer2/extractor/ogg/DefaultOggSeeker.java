...
final class DefaultOggSeeker implements OggSeeker {
    ...
    private class OggSeekMap implements SeekMap {
        ...
        public long getPosition(long j) {
            ...
            return DefaultOggSeeker.this.getEstimatedPosition(DefaultOggSeeker.this.startPosition, DefaultOggSeeker.this.streamReader.convertTimeToGranule(j), DashMediaSource.DEFAULT_LIVE_PRESENTATION_DELAY_FIXED_MS);
        }
