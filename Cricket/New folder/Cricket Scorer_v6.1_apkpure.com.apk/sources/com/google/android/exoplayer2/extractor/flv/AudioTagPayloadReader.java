...
final class AudioTagPayloadReader extends TagPayloadReader {
    ...
    public boolean parseHeader(ParsableByteArray parsableByteArray) throws TagPayloadReader.UnsupportedFormatException {
        if (!this.hasParsedAudioDataHeader) {
            ...
            if (this.audioFormat == 2) {
                ...
                this.output.format(Format.createAudioSampleFormat((String) null, this.audioFormat == 7 ? MimeTypes.AUDIO_ALAW : MimeTypes.AUDIO_ULAW, (String) null, -1, -1, 1, 8000, (readUnsignedByte & 1) == 1 ? 2 : 3, (List<byte[]>) null, (DrmInitData) null, 0, (String) null));
                this.hasOutputFormat = true;
    ...
    public void parsePayload(ParsableByteArray parsableByteArray, long j) {
        ...
        if (this.audioFormat == 2) {
            ...
            this.output.sampleMetadata(j, 1, bytesLeft, 0, (byte[]) null);
            return;
        }
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
        if (readUnsignedByte == 0 && !this.hasOutputFormat) {
            ...
            this.output.sampleMetadata(j, 1, bytesLeft2, 0, (byte[]) null);
        }
    }
}
