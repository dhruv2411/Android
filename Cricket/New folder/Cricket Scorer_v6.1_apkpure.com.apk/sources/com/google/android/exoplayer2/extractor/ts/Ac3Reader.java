...
public final class Ac3Reader implements ElementaryStreamReader {
            ...
            switch (this.state) {
                case 0:
                    if (!skipToNextSync(parsableByteArray)) {
                        ...
                        this.state = 1;
                        this.headerScratchBytes.data[0] = BidiOrder.AN;
    ...
    private void parseHeader() {
        ...
        this.sampleDurationUs = (C.MICROS_PER_SECOND * ((long) parseAc3SyncframeInfo.sampleCount)) / ((long) this.format.sampleRate);
    }
}
