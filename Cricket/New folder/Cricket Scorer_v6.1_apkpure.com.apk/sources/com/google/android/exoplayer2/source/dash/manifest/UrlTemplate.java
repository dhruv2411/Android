    ...
    public String buildUri(String str, int i, int i2, long j) {
        ...
        for (int i3 = 0; i3 < this.identifierCount; i3++) {
            ...
            if (this.identifiers[i3] == 1) {
                ...
                sb.append(String.format(Locale.US, this.identifierFormatTags[i3], new Object[]{Integer.valueOf(i)}));
            } else if (this.identifiers[i3] == 3) {
                sb.append(String.format(Locale.US, this.identifierFormatTags[i3], new Object[]{Integer.valueOf(i2)}));
            } else if (this.identifiers[i3] == 4) {
                sb.append(String.format(Locale.US, this.identifierFormatTags[i3], new Object[]{Long.valueOf(j)}));
            }
        }
