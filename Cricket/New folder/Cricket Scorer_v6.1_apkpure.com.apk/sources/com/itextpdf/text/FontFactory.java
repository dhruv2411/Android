...
public final class FontFactory {
    ...
    public static Font getFont(String str, String str2, float f, int i) {
        return getFont(str, str2, defaultEmbedding, f, i, (BaseColor) null);
    }

    public static Font getFont(String str, String str2, float f) {
        return getFont(str, str2, defaultEmbedding, f, -1, (BaseColor) null);
    }

    public static Font getFont(String str, String str2) {
        return getFont(str, str2, defaultEmbedding, -1.0f, -1, (BaseColor) null);
    }
    ...
    public static Font getFont(String str, float f, int i) {
        return getFont(str, defaultEncoding, defaultEmbedding, f, i, (BaseColor) null);
    }

    public static Font getFont(String str, float f) {
        return getFont(str, defaultEncoding, defaultEmbedding, f, -1, (BaseColor) null);
    }

    public static Font getFont(String str) {
        return getFont(str, defaultEncoding, defaultEmbedding, -1.0f, -1, (BaseColor) null);
    }
