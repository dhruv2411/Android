...
public class WebColors extends HashMap<String, int[]> {
    ...
    static {
        ...
        NAMES.put("burlywood", new int[]{222, 184, TsExtractor.TS_STREAM_TYPE_E_AC3, 255});
        ...
        NAMES.put("darkgoldenrod", new int[]{184, TsExtractor.TS_STREAM_TYPE_SPLICE_INFO, 11, 255});
        ...
        NAMES.put("pink", new int[]{255, PsExtractor.AUDIO_STREAM, XMPError.BADXMP, 255});
        ...
        NAMES.put("silver", new int[]{PsExtractor.AUDIO_STREAM, PsExtractor.AUDIO_STREAM, PsExtractor.AUDIO_STREAM, 255});
    ...
    public static BaseColor getRGBColor(String str) {
        ...
        if (lowerCase.startsWith("#") || missingHashColorFormat) {
            ...
            if (stringTokenizer2.hasMoreElements()) {
                iArr[3] = (int) (((double) (255.0f * Float.parseFloat(stringTokenizer2.nextToken()))) + 0.5d);
            }
            return new BaseColor(iArr[0], iArr[1], iArr[2], iArr[3]);
