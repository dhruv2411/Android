...
public class ElementFactory {
    ...
    public Font getFont(ChainedProperties chainedProperties) {
        ...
        return this.provider.getFont(str2, str3, true, parseFloat, chainedProperties.hasProperty(HtmlTags.S) ? i | 8 : i, HtmlUtilities.decodeColor(chainedProperties.getProperty("color")));
    }
    ...
    public HyphenationEvent getHyphenation(ChainedProperties chainedProperties) {
        ...
        int i2 = 2;
        if (indexOf == -1) {
            return new HyphenationAuto(property, (String) null, 2, 2);
        }
