    ...
    public static class PdfImportedLink {
        ...
        PdfImportedLink(PdfDictionary pdfDictionary) {
            ...
            try {
                ...
                this.rect = new PdfArray(pdfArray);
        ...
        public void transformRect(float f, float f2, float f3, float f4, float f5, float f6) {
            this.llx = (this.llx * f) + (this.lly * f3) + f5;
            this.lly = (this.llx * f2) + (this.lly * f4) + f6;
            this.urx = (this.urx * f) + (this.ury * f3) + f5;
            this.ury = (this.urx * f2) + (this.ury * f4) + f6;
        }
        ...
        public String toString() {
            ...
            if (this.parameters != null) {
                appendDictionary(stringBuffer, this.parameters);
            }
