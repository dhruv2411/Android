...
public class Path extends ArrayList<Point.LongPoint> {
    ...
    public double area() {
        ...
        while (true) {
            ...
            d += (((double) ((Point.LongPoint) get(i4)).getX()) + ((double) ((Point.LongPoint) get(i2)).getX())) * (((double) ((Point.LongPoint) get(i4)).getY()) - ((double) ((Point.LongPoint) get(i2)).getY()));
            i = i2 + 1;
        }
    }
    ...
    public int isPointInPolygon(Point.LongPoint longPoint) {
        ...
        int i7 = 1;
        while (i7 <= size) {
            Point.LongPoint longPoint3 = (Point.LongPoint) (i7 == size ? get(i4) : get(i7));
            if (longPoint3.getY() == longPoint.getY()) {
                if (longPoint3.getX() != longPoint.getX()) {
                    if (longPoint2.getY() == longPoint.getY()) {
                        if ((longPoint3.getX() > longPoint.getX() ? i5 : i4) == (longPoint2.getX() < longPoint.getX() ? i5 : i4)) {
                        }
                    }
                }
                return -1;
            }
            if ((longPoint2.getY() < longPoint.getY() ? i5 : i4) != (longPoint3.getY() < longPoint.getY() ? i5 : i4)) {
                if (longPoint2.getX() < longPoint.getX()) {
                    i = i7;
                    i3 = i6;
                    if (longPoint3.getX() > longPoint.getX()) {
                        double x = (((double) (longPoint2.getX() - longPoint.getX())) * ((double) (longPoint3.getY() - longPoint.getY()))) - (((double) (longPoint3.getX() - longPoint.getX())) * ((double) (longPoint2.getY() - longPoint.getY())));
                        if (x == 0.0d) {
                            return -1;
                        }
                    ...
                    i = i7;
                    int i8 = i6;
                    double x2 = (((double) (longPoint2.getX() - longPoint.getX())) * ((double) (longPoint3.getY() - longPoint.getY()))) - (((double) (longPoint3.getX() - longPoint.getX())) * ((double) (longPoint2.getY() - longPoint.getY())));
                    if (x2 == 0.0d) {
                        return -1;
                    }
