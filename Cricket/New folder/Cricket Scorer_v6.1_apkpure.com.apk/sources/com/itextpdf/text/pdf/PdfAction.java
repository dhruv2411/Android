...
public class PdfAction extends PdfDictionary {
    ...
    public static PdfAction javaScript(String str, PdfWriter pdfWriter, boolean z) {
        ...
        if (z && str.length() < 50) {
            pdfAction.put(PdfName.JS, new PdfString(str, PdfObject.TEXT_UNICODE));
    ...
    public static PdfAction createHide(PdfAnnotation pdfAnnotation, boolean z) {
        return createHide((PdfObject) pdfAnnotation.getIndirectReference(), z);
    }

    public static PdfAction createHide(String str, boolean z) {
        return createHide((PdfObject) new PdfString(str), z);
    }
    ...
    static PdfArray buildArray(Object[] objArr) {
        ...
        for (String str : objArr) {
            if (str instanceof String) {
                pdfArray.add((PdfObject) new PdfString(str));
            } else if (str instanceof PdfAnnotation) {
                pdfArray.add((PdfObject) ((PdfAnnotation) str).getIndirectReference());
            } else {
    ...
    public static PdfAction createHide(Object[] objArr, boolean z) {
        return createHide((PdfObject) buildArray(objArr), z);
    }
    ...
    public void next(PdfAction pdfAction) {
        ...
        if (pdfObject == null) {
            ...
            pdfArray.add((PdfObject) pdfAction);
            put(PdfName.NEXT, pdfArray);
        } else {
            ((PdfArray) pdfObject).add((PdfObject) pdfAction);
        }
    }
