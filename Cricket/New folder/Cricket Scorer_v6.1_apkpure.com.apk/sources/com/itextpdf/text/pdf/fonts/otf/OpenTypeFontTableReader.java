...
public abstract class OpenTypeFontTableReader {
    ...
    private void readScriptRecord(int i, Map<String, Integer> map) throws IOException {
        map.put(this.rf.readString(4, AudienceNetworkActivity.WEBVIEW_ENCODING), Integer.valueOf(i + this.rf.readShort()));
    }
    ...
    private void readLangSysRecord(Map<String, Integer> map) throws IOException {
        map.put(this.rf.readString(4, AudienceNetworkActivity.WEBVIEW_ENCODING), Integer.valueOf(this.rf.readShort()));
    }
    ...
    private void readLangSysTable(int i) throws IOException {
        ...
        short readShort2 = this.rf.readShort();
        Logger logger2 = LOG;
        logger2.debug("reqFeatureIndex=" + readShort2);
        short readShort3 = this.rf.readShort();
    ...
    private void readFeatureListTable(int i) throws IOException {
        ...
        for (int i2 = 0; i2 < readShort; i2++) {
            linkedHashMap.put(this.rf.readString(4, AudienceNetworkActivity.WEBVIEW_ENCODING), Short.valueOf(this.rf.readShort()));
        }
        for (String str : linkedHashMap.keySet()) {
            Logger logger2 = LOG;
    ...
    private void readFeatureTable(int i) throws IOException {
        ...
        short readShort2 = this.rf.readShort();
        Logger logger2 = LOG;
        logger2.debug("lookupCount=" + readShort2);
