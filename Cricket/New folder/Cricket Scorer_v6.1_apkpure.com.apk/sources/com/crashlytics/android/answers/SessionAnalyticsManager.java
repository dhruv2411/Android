...
class SessionAnalyticsManager implements BackgroundManager.Listener {
    ...
    public static SessionAnalyticsManager build(Kit kit, Context context, IdManager idManager, String str, String str2, long j) {
        ...
        return new SessionAnalyticsManager(new AnswersEventsHandler(kit2, context2, answersFilesManagerProvider, sessionMetadataCollector, defaultHttpRequestFactory, buildSingleThreadScheduledExecutorService, new FirebaseAnalyticsApiAdapter(context2)), activityLifecycleManager, backgroundManager2, AnswersPreferenceManager.build(context2), j);
    }
