...
class DefaultSettingsSpiCall extends AbstractSpiCall implements SettingsSpiCall {
    ...
    public org.json.JSONObject invoke(io.fabric.sdk.android.services.settings.SettingsRequest r8) {
        /*
            r7 = this;
            r0 = 0
            java.util.Map r1 = r7.getQueryParamsFor(r8)     // Catch:{ HttpRequestException -> 0x007a, all -> 0x0075 }
            io.fabric.sdk.android.services.network.HttpRequest r2 = r7.getHttpRequest(r1)     // Catch:{ HttpRequestException -> 0x007a, all -> 0x0075 }
            io.fabric.sdk.android.services.network.HttpRequest r8 = r7.applyHeadersTo(r2, r8)     // Catch:{ HttpRequestException -> 0x0072, all -> 0x006f }
            io.fabric.sdk.android.Logger r2 = io.fabric.sdk.android.Fabric.getLogger()     // Catch:{ HttpRequestException -> 0x006d }
            java.lang.String r3 = "Fabric"
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ HttpRequestException -> 0x006d }
            ...
            java.lang.String r5 = r7.getUrl()     // Catch:{ HttpRequestException -> 0x006d }
            r4.append(r5)     // Catch:{ HttpRequestException -> 0x006d }
            java.lang.String r4 = r4.toString()     // Catch:{ HttpRequestException -> 0x006d }
            ...
            java.lang.String r1 = r4.toString()     // Catch:{ HttpRequestException -> 0x006d }
            r2.d(r3, r1)     // Catch:{ HttpRequestException -> 0x006d }
            org.json.JSONObject r1 = r7.handleResponse(r8)     // Catch:{ HttpRequestException -> 0x006d }
            ...
            java.lang.String r8 = r8.header((java.lang.String) r4)
            r3.append(r8)
