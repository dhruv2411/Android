...
public class CommonUtils {
    ...
    private static final char[] HEX_VALUES = {'0', '1', PdfWriter.VERSION_1_2, PdfWriter.VERSION_1_3, PdfWriter.VERSION_1_4, PdfWriter.VERSION_1_5, PdfWriter.VERSION_1_6, PdfWriter.VERSION_1_7, '8', '9', 'a', 'b', Barcode128.CODE_AB_TO_C, Barcode128.CODE_AC_TO_B, Barcode128.CODE_BC_TO_A, Barcode128.FNC1_INDEX};
    ...
    public static String hexify(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            cArr[i2 + 1] = HEX_VALUES[b & BidiOrder.B];
        }
