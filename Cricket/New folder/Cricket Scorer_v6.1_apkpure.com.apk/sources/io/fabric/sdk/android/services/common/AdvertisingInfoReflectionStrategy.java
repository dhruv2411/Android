...
class AdvertisingInfoReflectionStrategy implements AdvertisingInfoStrategy {
    ...
    public boolean isGooglePlayServiceAvailable(Context context2) {
        try {
            if (((Integer) Class.forName(CLASS_NAME_GOOGLE_PLAY_SERVICES_UTILS).getMethod(METHOD_NAME_IS_GOOGLE_PLAY_SERVICES_AVAILABLE, new Class[]{Context.class}).invoke((Object) null, new Object[]{context2})).intValue() == 0) {
                return true;
            }
            return false;
    ...
    private Object getInfo() {
        try {
            return Class.forName(CLASS_NAME_ADVERTISING_ID_CLIENT).getMethod(METHOD_NAME_GET_ADVERTISING_ID_INFO, new Class[]{Context.class}).invoke((Object) null, new Object[]{this.context});
        } catch (Exception unused) {
