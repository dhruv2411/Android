        ...
        synchronized (this) {
            try {
                ...
                if (this.settingsController == null) {
                    ...
                    this.settingsController = new DefaultSettingsController(kit2, new SettingsRequest(value, modelName, osBuildVersionString, osDisplayVersionString, appInstallIdentifier, CommonUtils.createInstanceIdFrom(CommonUtils.resolveBuildId(context)), str2, str, DeliveryMechanism.determineFrom(installerPackageName).getId(), appIconHashOrNull), systemCurrentTimeProvider, defaultSettingsJsonTransform, defaultCachedSettingsIo, defaultSettingsSpiCall2);
                }
