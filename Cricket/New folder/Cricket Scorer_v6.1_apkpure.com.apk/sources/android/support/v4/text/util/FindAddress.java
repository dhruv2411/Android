...
class FindAddress {
    ...
    private static boolean checkHouseNumber(String str) {
        ...
        switch (parseInt % 10) {
            case 1:
                return lowerCase.equals(parseInt % 100 == 11 ? HtmlTags.TH : "st");
            case 2:
                return lowerCase.equals(parseInt % 100 == 12 ? HtmlTags.TH : "nd");
            case 3:
                return lowerCase.equals(parseInt % 100 == 13 ? HtmlTags.TH : "rd");
            default:
                return lowerCase.equals(HtmlTags.TH);
        }
    }
