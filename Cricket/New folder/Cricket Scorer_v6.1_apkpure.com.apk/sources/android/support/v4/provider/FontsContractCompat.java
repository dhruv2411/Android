...
public class FontsContractCompat {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Uri build2 = new Uri.Builder().scheme("content").authority(str2).appendPath(Annotation.FILE).build();
        Cursor cursor = null;
        try {
            int i = 0;
            ...
            if (cursor2 != null && cursor2.getCount() > 0) {
                ...
                while (cursor2.moveToNext()) {
                    ...
                    arrayList2.add(new FontInfo(withAppendedId, i3, columnIndex5 != -1 ? cursor2.getInt(columnIndex5) : 400, columnIndex6 != -1 && cursor2.getInt(columnIndex6) == 1, i2));
                    i = 0;
                }
