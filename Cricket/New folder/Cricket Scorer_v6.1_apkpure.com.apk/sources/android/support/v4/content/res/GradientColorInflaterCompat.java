...
final class GradientColorInflaterCompat {
    ...
    static Shader createFromXmlInner(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        int namedInt = TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser2, DublinCoreProperties.TYPE, R.styleable.GradientColor_android_type, 0);
        ...
        switch (namedInt) {
            ...
            default:
                return new LinearGradient(f4, f3, f2, f, checkColors.mColors, checkColors.mOffsets, parseTileMode(namedInt2));
        }
    }
