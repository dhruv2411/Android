...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        if (z) {
            ...
            i = save;
            f2 = f10;
            canvas2.drawRect(0.0f, f5, this.contentBounds.width() - f7, -this.cornerRadius, this.edgeShadowPaint);
        } else {
            i2 = save2;
            f = f11;
            i = save;
        ...
        if (z) {
            ...
            f3 = f2;
            f4 = f12;
            canvas2.drawRect(0.0f, f5, this.contentBounds.width() - f7, (-this.cornerRadius) + this.shadowSize, this.edgeShadowPaint);
        } else {
            f3 = f2;
            f4 = f12;
        }
        ...
        if (z2) {
            ...
            canvas2.drawRect(0.0f, f5, this.contentBounds.height() - f7, -this.cornerRadius, this.edgeShadowPaint);
        }
    ...
    private void buildShadowCorners() {
        ...
        if (f > 0.0f) {
            ...
            RadialGradient radialGradient2 = new RadialGradient(0.0f, 0.0f, f, new int[]{0, this.shadowStartColor, this.shadowMiddleColor, this.shadowEndColor}, fArr, Shader.TileMode.CLAMP);
