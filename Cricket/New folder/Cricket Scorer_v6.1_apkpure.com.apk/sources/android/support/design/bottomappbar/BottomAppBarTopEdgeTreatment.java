...
public class BottomAppBarTopEdgeTreatment extends EdgeTreatment {
    ...
    public void getEdgePath(float f, float f2, ShapePath shapePath) {
        ...
        float f14 = f5 * 2.0f;
        float f15 = degrees;
        shapePath2.addArc(f13, 0.0f, f10 + f5, f14, 270.0f, degrees);
        shapePath2.addArc(f6 - f4, (-f4) - f7, f6 + f4, f4 - f7, 180.0f - f12, (f12 * 2.0f) - 180.0f);
        shapePath2.addArc(f11 - f5, 0.0f, f11 + f5, f14, 270.0f - f15, f15);
        shapePath2.lineTo(f3, 0.0f);
    }
