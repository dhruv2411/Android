...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:9:0x001c A[Catch:{ IOException | XmlPullParserException -> 0x0043 }] */
    ...
    public static android.support.design.chip.ChipDrawable createFromResource(android.content.Context r4, @android.support.annotation.XmlRes int r5) {
        /*
            android.content.res.Resources r0 = r4.getResources()     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            android.content.res.XmlResourceParser r0 = r0.getXml(r5)     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
        L_0x0008:
            int r1 = r0.next()     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            r2 = 2
        ...
        L_0x0012:
            ...
            org.xmlpull.v1.XmlPullParserException r4 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            java.lang.String r0 = "No start tag found"
            r4.<init>(r0)     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            throw r4     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
        L_0x001c:
            java.lang.String r1 = r0.getName()     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            java.lang.String r2 = "chip"
            boolean r1 = android.text.TextUtils.equals(r1, r2)     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            ...
            throw r4     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
        L_0x0030:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r0)     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            int r1 = r0.getStyleAttribute()     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            if (r1 != 0) goto L_0x003c
            int r1 = android.support.design.R.style.Widget_MaterialComponents_Chip_Entry     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
        L_0x003c:
            int r2 = android.support.design.R.attr.chipStandaloneStyle     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            android.support.design.chip.ChipDrawable r4 = createFromAttributes(r4, r0, r2, r1)     // Catch:{ IOException | XmlPullParserException -> 0x0043 }
            return r4
        L_0x0043:
            r4 = move-exception
    ...
    private boolean onStateChange(int[] iArr, int[] iArr2) {
        ...
        int colorForState4 = (this.textAppearance == null || this.textAppearance.textColor == null) ? 0 : this.textAppearance.textColor.getColorForState(iArr, this.currentTextColor);
