...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                if ((RecyclerView.this.mAdapter != null && doesTransientStatePreventRecycling && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) || viewHolder.isRecyclable()) {
                    if (this.mViewCacheMax <= 0 || viewHolder.hasAnyOfTheFlags(MetaDo.META_SETVIEWPORTEXT)) {
                        z = false;
                    } else {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(@NonNull VH vh, int i) {
            ...
            vh.setFlags(1, TIFFConstants.TIFFTAG_JPEGQTABLES);
    ...
    public int getAdapterPositionFor(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(MetaDo.META_SETWINDOWEXT) || !viewHolder.isBound()) {
            return -1;
        }
