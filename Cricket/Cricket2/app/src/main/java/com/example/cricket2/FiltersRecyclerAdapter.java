...
public class FiltersRecyclerAdapter extends RecyclerView.Adapter<FiltersRecyclerAdapter.DetailsItemHolder> {

    ArrayList<filterModel> details;
    Context context;
    int num;
    int img1;
    int img2;

    public FiltersRecyclerAdapter(ArrayList<filterModel> details, Context context) {
    ...
    public void onBindViewHolder(DetailsItemHolder holder, int position) {
        final filterModel thisDetail = details.get(position);
